...
public:
    ...
    virtual Handle<IShader> CreateLambertian(const Material& material) = 0;
    virtual Handle<IShader> CreatePhong(const Material& material) = 0;
    virtual Handle<IShader> CreateMirror() = 0;
    virtual Handle<IShader> CreateDiffuseShader(const Material& material) = 0;
    virtual Handle<IShader> CreateEmitter(const Material& material) = 0;
